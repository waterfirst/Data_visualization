...
#box(width: 1200.0pt, image("https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/R_logo.svg/1200px-R_logo.svg.png"))
...
#box(width: 635.0pt, image("https://149357281.v2.pressablecdn.com/wp-content/uploads/2017/09/9.28-1.png"))
...
== 프로그램 구분
<프로그램-구분>
#box(width: 790.0pt, image("https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FHzmVo%2FbtqYo0P6SWZ%2FtDiMUtNpC8VETbYmmx7nW1%2Fimg.png"))
...
+ R 설치, 기본문법 \(1주차)
  ...
  #link("https://dplyr.tidyverse.org/articles/dplyr.html")

+ 데이터 전처리 dplyr \(2주차)

  #link("https://m-clark.github.io/data-processing-and-visualization/intro.html")
...
+ 다양한 데이터 시각화 연습 \(5주차)
  ...
  - #box(width: 254.0pt, image("images/logo1.png"))

+ 다양한 데이터 시각화 연습2 \(6주차)

  - html로 문서 만들기

    #link("https://waterfirst.github.io/LENS_EXPERIMENT/")
