...
```{r}
#데이터 불러오기
X_test <- read.csv("../input/used-car-price-dataset-competition-format/X_test.csv", stringsAsFactors=T)
X_train <- read.csv("../input/used-car-price-dataset-competition-format/X_train.csv", stringsAsFactors=T)
y_train <- read.csv("../input/used-car-price-dataset-competition-format/y_train.csv", stringsAsFactors=T)
y_test <- read.csv("../input/used-car-price-dataset-competition-format/test_label/y_test.csv", stringsAsFactors=T)
